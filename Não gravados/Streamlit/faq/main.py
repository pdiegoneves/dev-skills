...
logo.image(
    r"https://streamlit.io/images/brand/streamlit-logo-primary-colormark-darktext.png"
)
titulo.title("F.A.Q")
...
with metricas:
    metricas_col1.metric("Visitantes Semanais", 135, border=True, delta="5")
    metricas_col2.metric("Visitantes Mensais", 520, border=True, delta="-20")
    metricas_col3.button("Mostrar", on_click=chart)
